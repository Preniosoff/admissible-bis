  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        abonnementSucces: resolve(__dirname, 'src/abonnement-succes.html'),
        ...
        profParticulier: resolve(__dirname, 'src/prof-particulier.html'),
        espaceProfParticulier: resolve(__dirname, 'src/espace-prof-particulier.html'),
